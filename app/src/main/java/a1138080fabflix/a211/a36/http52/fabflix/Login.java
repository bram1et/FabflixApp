    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                String urlFormat = String.format("http://52.36.211.113:8080/fabflix/loginandroid?email=%s&password=%s", mEmail, mPassword);
                MyHTTPConnection httpConnection = new MyHTTPConnection(urlFormat);
